...
<body>
<center>
<form method="post" action="yijian_panduan.jsp">
  <p><strong>不同意意见</strong> </p>
  <table width="279" border="0">
    ...
    %>
      <tr>
        <td width="125">机构编码：</td>
        <td width="173"><input name="no" id="jgbm" value=<%=no %> readOnly="true"></td>
      </tr>
      <tr>
        <td>需求编码：</td>
        <td><input name="tech" id="xqbm" value=<%=tech_no %> readOnly="true"></td>
      </tr>
      <tr>
        <td>意见填写：</td>
        <td><textarea rows="3" name="xsshyj" style="width:200px;height:150px"></textarea>
      </tr>
    </tbody>
</table>
