...
<body>
	...
	String s = "select name from info where no='"+no+"';";
	ResultSet rs = db.executeQuery(s);
	rs.next();
	%>
    <span><img src="../images/sun.png" alt="天气" /></span>
    <b><%=rs.getString(1) %> 你好，欢迎使用河北省重大技术需求征集系统</b>
    </div>
    ...
    <li><img src="../images/ico02.png" /><p><a href="#">查看需求</a></p></li>
    ...
    <ul class="infolist">
    <li><span>您可以快速查看待进行形式审核的表单</span><a class="ibtn" href="#">查看表单</a></li>
    <li><span>您可以快速查看待进行技术审核的表单</span><a class="ibtn" href="#">查看表单</a></li>
    <li><span>您可以快速进行密码修改</span><a class="ibtn" href="../xgmm/xgmm.jsp?no= <%=no%>">修改密码</a></li>
    </ul>
